...
func GenTrackerStub() string {
	for _, tracker := range trackers {
		encodedTracker := url.QueryEscape(tracker)
		URLencodedTrackers = append(URLencodedTrackers, encodedTracker)
	}
	return strings.Join(URLencodedTrackers, "&tr=")
}
